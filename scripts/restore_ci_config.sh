...
LECTURE_REVIEW_MAX_AGE_MINUTES=60
...
DISCORD_LECTURE_SUMMARIES_CHANNEL_ID=${DISCORD_LECTURE_SUMMARIES_CHANNEL_ID:-}
...
GEMINI_LECTURE_SUMMARY_MODEL=${GEMINI_LECTURE_SUMMARY_MODEL:-}
